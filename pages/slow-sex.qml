    ...
    Section {
        ...
        Row {
            ...
            Column {
                ...
                Text {
                    text: "&lt;div class=&quot;owl-carousel controlls-over product-image&quot; data-plugin-options=&#x27;{&quot;items&quot;: 1, &quot;singleItem&quot;: true, &quot;navigation&quot;: true, &quot;pagination&quot;: false, &quot;transitionStyle&quot;:&quot;fadeUp&quot;}&#x27;&gt;
	&lt;div&gt;
		&lt;img alt=&quot;slow sex coaching&quot; class=&quot;img-responsive&quot; src=&quot;assets/images/coaching.png&quot;&gt;
	&lt;/div&gt;
...
&lt;/div&gt;"
	...
	&lt;p&gt;
		Du erfährst deine Sexualität auf ganz andere, achtsame Weise, weit weg von der
		herkömmlichen &quot;schnellen Nummer&quot;.
		Du wirst tief mit dir selbst verbunden.
		Du wirst einen Raum erleben, in dem sich viele wundervolle Dinge zeigen und
		ereignen können.
	&lt;/p&gt;
&lt;/div&gt;"
                    adminlabel: "Lernziel"
...
&lt;/div&gt;"
	...
	&lt;p&gt;
		...
		oder sogar verletzt zu werden. Durch diese Panzerung fühlt die Frau sehr wenig,
		wenn überhaupt etwas in ihrer Yoni. Was sich denn in Wünschen wie z.B. &quot;Nimm mich
		hart ran&quot; äussern kann, da sie ansonsten nicht viel fühlt. Dies sorgt dann für
		einige Männer für Probleme, weil sie dann evtl. viel zu früh anfangen zu ejakulieren
		und dann zwangsweise eine Pause benötigen, was bei einer Frau für Frust sorgen
		kann, weil sie es nicht geschafft hat, in dieser kurzen Zeit zum Höhepunkt zu kommen. 
	&lt;/p&gt;
&lt;/div&gt;"
